        ...
        <div>
            ...
            <div className={css.Pads}>
                ...
                <div className={css.Button}>
                    <NavLink to={_id}>
                        <Button shadow color="warning">More</Button>
                    </NavLink>
                </div>
                <hr className={css.Hr}/>
            </div>
            ...
            <div className={css.Laptops} style={divStyle} onClick={toggleHeight}>
                ...
                <div className={css.TextDiv3}>
                    <Text h5>{course_format == null || course_format === '' ? 'null': course_format}</Text>
                </div>
                <div className={css.TextDiv3}>
                    <Text h5>{course_type == null || course_type === '' ? 'null': course_type}</Text>
                </div>
                <div className={css.TextDiv2}>
                ...
                <div className={css.TextDiv2}>
                    <Text h5>{already_paid == null || already_paid === '' ? 'null': already_paid}</Text>
                </div>
            </div>
            <form style={contentStyle} className={css.Edit} onSubmit={handleSubmit(comment)}>
                <Button
                    shadow
                    color="success"
                    size="lg"
            ...
            <Snackbar
                ...
                <Alert onClose={() => setCommentCreated(false)} severity="success" sx={{ width: '100%' }}>
