    ...
    return (
        <form onSubmit={handleSubmit(update)}>
                ...
                <div className={css.Mother}>
                    ...
                    <div>
                        <Dropdown>
                            <Dropdown.Button
                                flat
                                color="warning"
                                css={isMobile ? { tt: "capitalize", height: "4vh", width: "20vw" } : { tt: "capitalize", height: "4vh" }}
                                size={isMobile ? "lg" : "sm"}
                                auto
                            >
                                {selectedValueGroup}
                    ...
                    <div>
                        <Button
                            ...
                            auto
                            css={isMobile ? { height: "2vh", width: "20vw" } : { height: "3vh" }}>
                            Add Group
                        </Button>
                        <Modal
                            closeButton
            ...
            <Snackbar
                ...
                <Alert onClose={() => setOrderUpdated(false)} severity="success" sx={{ width: '100%' }}>
