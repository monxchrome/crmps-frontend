...
const Orders: FC = () => {
  ...
  const { orders, trigger, page, loading } = useAppSelector(
          ...
          <div className={css.Mother}>
            ...
            <div className={css.UserDivPC}>
              <div className={css.WrapText}>
                ...
                <Text h4 className={css.Text} onClick={() => handleSort("age")}>
                  Age
                </Text>
                <Text
                  h4
                ...
                <Text h4 className={css.Text} onClick={() => handleSort("sum")}>
                  Sum
                </Text>
                <Text
                  h4
                  className={css.Text}
                  onClick={() => handleSort("already_paid")}
                >
                  Already paid
                </Text>
              </div>
